...
+ Core developer packages
    + For Debian 9:  
    ```sudo apt install -y axel build-essential make gawk git subversion texinfo autoconf autopoint pkg-config gettext txt2man liblzma-dev libssl-dev libz-dev flex bison```
